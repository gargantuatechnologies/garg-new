      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-[#B6E1F2] mb-12 leading-relaxed">
            ...
            transformar sua ideia em realidade com a mesma qualidade e dedicação.
          </p>
          ...
          >
            <Link href="/portfolio">
              <motion.div
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center gap-2 text-[#B6E1F2] hover:text-white font-medium transition-colors duration-300"
              >
